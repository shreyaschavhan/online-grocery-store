...
<head>
    ...
    <title>Add Store | Grocery Store</title>
...
<body class="grid">
    ...
    <main>
        ...
        <?php
			...
			if(isset($_GET['ok']))
			{
				echo '<font color="blue">Store successfully added!</font>';
				echo '<br><br>';
			}
        ...
        <section class="add_information-section">
            <form action="addstore_process.php" method="post">
                <div class="add_information grid">
                    <div class="add_information-box">
                        <h1 class="add_information-title">
                             Store Category ID
                        </h1>
                        <input type="number" name="store_catID" id="" placeholder="store_categoryID">
                    </div>
                    <div class="add_information-box">
                        <h1 class="add_information-title">
                             Store Name
                        </h1>
                        <input type="text" name="store_name" id="" placeholder="store_name">
                    </div>
                    <div class="add_information-box">
                        <h1 class="add_information-title">
                             Store Category
                        </h1>
                        <input type="text" name="store_category" id="" placeholder="store_category">
                    </div>
                    <div class="add_information-box">
                        <h1 class="add_information-title">
                             Store Region
                        </h1>
                        <input type="text" name="store_region" id="" placeholder="store_region">
                    </div>
                    <div class="add_information-box">
                        <h1 class="add_information-title">
                             Store Image
                        </h1>
                        <input type="text" name="store_image" id="" placeholder="store_image">
                    </div>
                    <div class="add_information-box">
                        <h1 class="add_information-title">
                             Store Owner Username
                        </h1>
                        <input type="text" name="store_username" id="" placeholder="store_username">
                    </div>
                    <div class="add_information-box">
                        <h1 class="add_information-title">
                             Store Owner Password
                        </h1>
                        <input type="text" name="store_password" id="" placeholder="store_password">
                    </div>
                </div>
